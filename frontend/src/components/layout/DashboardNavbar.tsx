...
import { User, LogOut, CreditCard, Activity, Gift } from 'lucide-react';
...
const DashboardNavbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-64 right-0 z-40 h-16 bg-background/80 backdrop-blur-sm border-b border-border/50">
