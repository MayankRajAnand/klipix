...
const taglines = ["Create Viral Shorts from Long Videos", "Generate AI-Powered Faceless Videos", "Auto-Create Scroll-Stopping Clips", "Transform Podcasts into Viral Reels", "Generate Viral Scripts in Seconds"];
const HeroSection = ({
  onOpenAuth
}: HeroSectionProps) => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-accent/20 blur-[150px] animate-pulse-glow" style={{
        animationDelay: "1.5s"
      }} />
      </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          delay: 0.1
            ...
            <AnimatePresence mode="wait">
              <motion.span key={currentTaglineIndex} initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
          ...
          delay: 0.3
            ...
            <Button variant="gradient" size="xl" onClick={() => onOpenAuth("signup")} className="w-full sm:w-auto">
              Get Started Free
          ...
          delay: 0.4
            ...
            {platforms.map(platform => <div key={platform.name} className="flex items-center gap-2 text-muted-foreground">
          ...
          delay: 0.5
            ...
            <div className="glass-card p-2 rounded-2xl glow-effect">
              <img src={heroVisual} alt="KlipIx AI Video Editor Interface" className="w-full rounded-xl" />
            </div>
            {/* Floating Elements */}
            <motion.div animate={{
            y: [-10, 10, -10]
            ...
            repeat: Infinity
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted-foreground">Added successfully</p>
              </div>
            </motion.div>
            <motion.div animate={{
            y: [10, -10, 10]
            ...
            delay: 1
              ...
              <div className="text-left">
                <p className="text-sm font-semibold text-foreground">12 Clips Created</p>
